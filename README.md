...
Этот проект был создан как быстрый MVP за ~4,5 часа с использованием AI-инструментов.
Основной фокус — на корректную бизнес-логику, удобный UX, без избыточных усложнений.

Архитектура и структура кода здесь не отражают мой основной подход к разработке.
Для примера более продуманной архитектуры см. проект Danetka: https://github.com/animepusya/Danetka
